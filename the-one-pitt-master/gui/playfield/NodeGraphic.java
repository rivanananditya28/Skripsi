...
public class NodeGraphic extends PlayFieldGraphic {
    ...
    public NodeGraphic(String warna) {
        Color color = stringToColor(warna);
//        try {
//            Field field = Class.forName("java.awt.Color").getField("warna");
...
//        }
    ...
    protected NodeGraphic(NodeGraphic proto) {
        this.conColor = proto.conColor;
        this.hostColor = proto.hostColor;
    }
...
//			ArrayList<Connection> conList = new ArrayList<Connection>();
    ...
    public NodeGraphic replicate() {
        return new NodeGraphic(warna);
    }
