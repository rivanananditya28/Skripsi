...
public class DecisionEngineRouter extends ActiveRouter
{
	...
	protected RoutingDecisionEngineWithSpray decider;
	...
	public DecisionEngineRouter(Settings s)
	{
		...
		decider = (RoutingDecisionEngineWithSpray)routeSettings.createIntializedObject(
	...
	public RoutingDecisionEngineWithSpray getDecisionEngine()
	{
		return this.decider;
	}
